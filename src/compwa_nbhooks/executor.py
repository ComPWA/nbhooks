...
class Executor(AbstractContextManager):
    ...
    def error_messages(self) -> tuple[str, ...]:
        ...
        .. note::
            Set :code:`COMPWA_NBHOOKS_DEBUG=1` to enable profiling the execution times.
        """
    ...
    def __call__(
        ...
        try:  # noqa: PLW0717
            if os.getenv("COMPWA_NBHOOKS_DEBUG") != "0":
    ...
    def __exit__(
        ...
        if os.getenv("COMPWA_NBHOOKS_DEBUG") is not None:
