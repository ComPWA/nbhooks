...
[![Open in Visual Studio Code](https://img.shields.io/badge/vscode-open-blue?logo=visualstudiocode)](https://github.dev/ComPWA/nbhooks)
...
```shell
git clone https://github.com/ComPWA/nbhooks
cd nbhooks
```
